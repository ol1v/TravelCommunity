  ...
  <div>
    <div id="remove_account_wrapper">
      ...
      <input
        type="password"
        id="currentPass"
        class="remove-account-input font"
        v-model="password"
      ...
      <div id="remove_account_info">
        <p class="font">
          <span class="red-note">Notering!</span>
          <br />Om du raderar ditt konto kommer det att stängas av permanent.
          <br />
          <br />Om du kryssar i 'Radera alla min resor' kommer alla dina tidigare privata och publika resor att försvinna ur webbsidan.
          <br />
          <br />Är du säker att du vill radera ditt konto?
        </p>
      </div>
      ...
      <input
        type="button"
        value="Radera mitt konto"
        class="remove-account-button font"
        @click="removeAccount"
      />
    </div>
  </div>
    ...
    removeAccount() {
      ...
      if (this.readBool) {
        const data = {
          ...
          removeAllData: this.removeTripsBool
        };

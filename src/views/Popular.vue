<template>
  <div>
    <input type="button" @click="test" value="asd">

    <div class="content" v-for="num in travelArray.length" :key="num">
      {{num}}
...
export default {
  ...
  methods:{
    test(){
      console.log(this.travelArray.length)
      console.log(this.travelArray[0].milestones)
    }
  },
  created(){
